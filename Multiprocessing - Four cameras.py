...
if __name__ == '__main__':
    ...
    if dataframes:
        ...
        try:
            ...
            # Assuming each camera column is labeled distinctly
        ...
        try:
            ...
            # Get column names
            x1_name = combined_df.columns[0]
            y1_name = combined_df.columns[1]
            x2_name = combined_df.columns[2]
            y2_name = combined_df.columns[3]
            
            # Convert to numeric, with error handling
            combined_df = combined_df.apply(pd.to_numeric, errors='coerce')
            
            # Create the plots
            plt.plot(combined_df[x1_name], combined_df[y1_name], label='LKnee_Camera1')
            plt.plot(combined_df[x2_name], combined_df[y2_name], label='LKnee_Camera2')
